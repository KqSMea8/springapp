...
export class AddUserPage implements OnInit {
  ...
  constructor(public navCtrl: NavController, private _http: HttpProvider, public navParams: NavParams, private fb: FormBuilder, private empService: EmployeeProvider) {
  }
 ...
 isReadonly() {
  ...
  onSubmit() {
    ...
    this._http.postRequest("http://localhost:8080/initateemp/add-user", a).subscribe(data => {
      console.log(data);
    });
    this.navCtrl.pop();
  }
